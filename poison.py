...
def main(args):
    if not args.directory:
        raise ValueError("Input directory not specified or is empty.")
    if not args.outdir:
        raise ValueError("Output directory not specified or is empty.")
...
def parse_arguments(argv):
    ...
    parser.add_argument('-d', '--directory', type=str,
                        help="Input directory containing pickle files", default='')
    parser.add_argument('-od', '--outdir', type=str,
                        help="Output directory for poisoned images", default='')
